...
Orveyl.Parameters.innerHTML = `<form>` + [
    [,
        `BL:`,
        `<input id="BLi" ${num_input("#ff8")} name="BLi" value="${BL[0]}">`,
        `<input id="BLj" ${num_input("#f8f")} name="BLj" value="${BL[1]}">`,
        `<input id="BLk" ${num_input("#8ff")} name="BLk" value="${BL[2]}">`,
        ` :: `,
        `<input id="BLX" ${num_input("#f88")} name="BLX" value="${BL[3]}">`,
        `<input id="BLY" ${num_input("#8f8")} name="BLY" value="${BL[4]}">`,
        `<input id="BLZ" ${num_input("#88f")} name="BLZ" value="${BL[5]}">`,
    ].join(" "),
    [,
        `BR:`,
        `<input id="BRi" ${num_input("#ff8")} name="BRi" value="${BR[0]}">`,
        `<input id="BRj" ${num_input("#f8f")} name="BRj" value="${BR[1]}">`,
        `<input id="BRk" ${num_input("#8ff")} name="BRk" value="${BR[2]}">`,
        ` :: `,
        `<input id="BRX" ${num_input("#f88")} name="BRX" value="${BR[3]}">`,
        `<input id="BRY" ${num_input("#8f8")} name="BRY" value="${BR[4]}">`,
        `<input id="BRZ" ${num_input("#88f")} name="BRZ" value="${BR[5]}">`,
    ].join(" "),
    ``,
    [,
        `ΔL:`,
        `<input id="DLi" ${num_input("#ff8")} name="DLi" value="${DL[0]}">`,
        `<input id="DLj" ${num_input("#f8f")} name="DLj" value="${DL[1]}">`,
        `<input id="DLk" ${num_input("#8ff")} name="DLk" value="${DL[2]}">`,
        ` :: `,
        `<input id="DLX" ${num_input("#f88")} name="DLX" value="${DL[3]}">`,
        `<input id="DLY" ${num_input("#8f8")} name="DLY" value="${DL[4]}">`,
        `<input id="DLZ" ${num_input("#88f")} name="DLZ" value="${DL[5]}">`,
    ].join(" "),
    [,
        `ΔR:`,
        `<input id="DRi" ${num_input("#ff8")} name="DRi" value="${DR[0]}">`,
        `<input id="DRj" ${num_input("#f8f")} name="DRj" value="${DR[1]}">`,
        `<input id="DRk" ${num_input("#8ff")} name="DRk" value="${DR[2]}">`,
        ` :: `,
        `<input id="DRX" ${num_input("#f88")} name="DRX" value="${DR[3]}">`,
        `<input id="DRY" ${num_input("#8f8")} name="DRY" value="${DR[4]}">`,
        `<input id="DRZ" ${num_input("#88f")} name="DRZ" value="${DR[5]}">`,
    ].join(" "),
    ``,
    `Root Color: <input id="rootCol" type="color" value=#${rgb2hex(CO)}>`,
    `L Color: <input id="LCol" type="color" value=#${rgb2hex(CL)}> <input id="LColWeight" ${num_input("#fff")} name="LColWeight" value="${CL.w}">`,
    `R Color: <input id="RCol" type="color" value=#${rgb2hex(CR)}> <input id="RColWeight" ${num_input("#fff")} name="RColWeight" value="${CR.w}">`,
